...
from data import generate_data_mean_shift, er_adjacency_matrix
...
def parse_args():
    ...
    parser.add_argument("--shift_scale", type=float, default=1)
    ...
    parser.add_argument("--outdir", type=str, default="results_means_shift")
...
def run_experiment(args):
    ...
    # Data
    # ----------------------
    client_data, client_data_val, client_labels, client_labels_val, means  = generate_data_mean_shift(
