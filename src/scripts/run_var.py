...
from data import generate_data_var, er_adjacency_matrix
...
def parse_args():
    ...
    parser.add_argument("--reg_term", type=float, default=1, help="lambda coupling")
    ...
    parser.add_argument("--outdir", type=str, default="results_var")
...
def run_experiment(args):
    ...
    # Data
    # ----------------------
    client_data, client_data_val, client_labels, client_labels_val, means  = generate_data_var(
